# Stratospheric circulation diagnostics: T85L95, 2005-2009
...
|---|---|---|---|
| model: T85L95 | 13.6 / 14.1 / 12.4 / 7.8 | 8.7 / 15.5 / 13.8 | -12 / -7 |
| ERA5 | 17.5 / 17.5 / 15.2 / 10.7 | 30.7 / 20.7 / 15.6 | -13 / -8 |
| WACCM6 histSST (free-running, same years) | 12.5 / 10.0 / 8.6 / 4.6 | 18.4 / 20.0 / 18.0 | -3 / -1 |
...
|---|---|---|---|---|---|
| model: T85L95 | DJF | 9.2 | 13.0 | 4.6 | 1.93 |
| model: T85L95 | JJA | 6.6 | 9.3 | 2.7 | 1.08 |
| model: T85L95 | annual | 7.6 | 10.6 | 3.5 | 1.38 |
...
|---|---|---|---|
| model: T85L95 | 1.92 / 2.26 / 2.72 / 3.15 / 3.86 | 1.93 | 0.22 |
