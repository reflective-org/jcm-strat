# Stratospheric circulation diagnostics: T119L95, 2005-2009
...
|---|---|---|---|
| model: T119L95 | 13.6 / 14.1 / 12.4 / 7.9 | 8.4 / 15.3 / 13.7 | -12 / -7 |
...
|---|---|---|---|---|---|
| model: T119L95 | DJF | 9.3 | 13.2 | 4.7 | 1.96 |
| model: T119L95 | JJA | 6.4 | 9.1 | 2.6 | 1.02 |
| model: T119L95 | annual | 7.6 | 10.6 | 3.5 | 1.39 |
...
|---|---|---|---|
| model: T119L95 | 1.94 / 2.28 / 2.74 / 3.18 / 3.86 | 1.92 | 0.22 |
