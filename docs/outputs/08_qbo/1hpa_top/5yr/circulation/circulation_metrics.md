# Stratospheric circulation diagnostics: p8b_5yr (QBO nudged, window top 1 hPa), 2005-2009
...
|---|---|---|---|
| model: p8b_5yr (QBO nudged, window top 1 hPa) | 13.7 / 14.1 / 12.4 / 7.8 | 9.5 / 15.8 / 13.8 | -12 / -7 |
...
|---|---|---|---|---|---|
| model: p8b_5yr (QBO nudged, window top 1 hPa) | DJF | 9.4 | 13.1 | 4.7 | 1.95 |
| model: p8b_5yr (QBO nudged, window top 1 hPa) | JJA | 6.6 | 9.3 | 2.7 | 1.07 |
| model: p8b_5yr (QBO nudged, window top 1 hPa) | annual | 7.7 | 10.7 | 3.5 | 1.40 |
...
|---|---|---|---|
| model: p8b_5yr (QBO nudged, window top 1 hPa) | 1.90 / 2.24 / 2.69 / 3.13 / 3.87 | 1.96 | 0.22 |
