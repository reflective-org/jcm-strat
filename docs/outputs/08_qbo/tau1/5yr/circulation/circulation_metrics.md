# Stratospheric circulation diagnostics: p8e_5yr (QBO nudged, tau 1 d), 2005-2009
...
|---|---|---|---|
| model: p8e_5yr (QBO nudged, tau 1 d) | 15.7 / 16.1 / 14.2 / 9.3 | 17.2 / 18.2 / 13.7 | -13 / -8 |
...
|---|---|---|---|---|---|
| model: p8e_5yr (QBO nudged, tau 1 d) | DJF | 9.8 | 13.2 | 4.8 | 1.94 |
| model: p8e_5yr (QBO nudged, tau 1 d) | JJA | 7.1 | 9.8 | 2.9 | 1.05 |
| model: p8e_5yr (QBO nudged, tau 1 d) | annual | 8.2 | 11.1 | 3.7 | 1.37 |
...
|---|---|---|---|
| model: p8e_5yr (QBO nudged, tau 1 d) | 1.89 / 2.20 / 2.61 / 3.08 / 3.85 | 1.97 | 0.22 |
