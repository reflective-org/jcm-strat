# Stratospheric circulation diagnostics: p8_5yr (QBO nudged), 2005-2009
...
|---|---|---|---|
| model: p8_5yr (QBO nudged) | 13.6 / 14.1 / 12.4 / 7.8 | 4.7 / 5.6 / 5.5 | -12 / -7 |
...
|---|---|---|---|---|---|
| model: p8_5yr (QBO nudged) | DJF | 9.2 | 12.9 | 4.6 | 1.95 |
| model: p8_5yr (QBO nudged) | JJA | 6.7 | 9.4 | 2.8 | 1.14 |
| model: p8_5yr (QBO nudged) | annual | 7.7 | 10.7 | 3.6 | 1.43 |
...
|---|---|---|---|
| model: p8_5yr (QBO nudged) | 1.90 / 2.23 / 2.66 / 3.09 / 3.78 | 1.88 | 0.23 |
