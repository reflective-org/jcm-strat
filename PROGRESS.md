...
|---|---|---|---|
| 2026-09-10 | 8d/8e — QBO nudging, tau 2 d and 1 d; **tau 1 d is the default** | **done**: 2005-2009 chains `p8d_5yr`, `p8e_5yr`; amplitude 80 → 90 → 92 % of ERA5, QBO-layer error 4.0 → 2.3 m/s, global u RMSE 4.9 → 4.4, nothing else moves. Mean-preserving target interpolation added (`p8f_*`, running unattended at commit time; addendum follows) | [docs/outputs/08_qbo/output.md](docs/outputs/08_qbo/output.md) |
