...
Status: **Phases 0–3 done** (environment, stripped dry model, ERA5-nudged troposphere, passive tracers). Next: Phase 4, the 5-year run and the Phase-1 number. See [PROGRESS.md](PROGRESS.md).
